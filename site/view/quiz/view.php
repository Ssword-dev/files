...
<body class="flex flex-col justify-center align-center h-screen w-screen bg-muted">
  <div id="form-body" class="flex flex-col justify-center align-center h-screen w-screen bg-muted">
    <!-- <div id="identity">
    ...
    <div id="display-container"
      class="flex flex-col gap-3 self-center w-4/5 sm:w-5/6 h-4/5 sm:5/6 bg-primary border-main rounded-lg shadow-main shadow-sm">
